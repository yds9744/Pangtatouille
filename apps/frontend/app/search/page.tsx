    ...
    <main className="min-h-screen">
      ...
      <div className="flex flex-col">
        <div className="bg-gray-100 px-60 py-2">
          <span className="flex items-center text-sm">전체
        ...
        <a href="/products" key={product.name}>
          <Card key={index}>
            <CardContent className="p-4 w-[220px]">
              <Image src={product.image} alt="" width={230} height={230} className="w-full mb-2 rounded-lg"/>
              ...
              <div className="mt-2">
                ...
                <div className="flex items-center text-sm text-gray-600">
                  <span className="flex text-xs items-center border border-gray-300 rounded-full px-2 py-1">
                    최대 <Image src="https://image6.coupangcdn.com/image/badges/cashback/web/list-cash-icon@2x.png" alt="" width={15} height={15} className="mx-1" /> {product.reward_cash}원 적립</span>
                </div>
              </div>
            </CardContent>
          </Card>
